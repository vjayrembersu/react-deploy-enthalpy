...
const HospitalAdminMainBodyManageICDNonInterventions = () => {
  const options = [
  ...
  return (
    <MainViewPageBodyConfig setHedearName="Hospital Admin Manage ICD Codes Non Interventions ">
      <Formik
...
export default HospitalAdminMainBodyManageICDNonInterventions