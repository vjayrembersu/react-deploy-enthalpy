...
const HospitalAdminMainBodyManageInterventionsAppointments = () => {
  const options = [
  ...
  return (
    <MainViewPageBodyConfig setHedearName="Hospital Admin Manage Interventions Appointments">
      <Formik
...
export default HospitalAdminMainBodyManageInterventionsAppointments