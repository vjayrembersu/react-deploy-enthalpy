...
const HospitalAdminMainBodyAddInsurance = () => {
  const options = [
  ...
  return (
    <MainViewPageBodyConfig setHedearName="Hospital Admin New Insurance">
      <Formik
...
export default HospitalAdminMainBodyAddInsurance;
