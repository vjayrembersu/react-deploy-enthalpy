...
const HospitalAdminMainBodyUpdateInsurance = () => {
  const options = [
  ...
  return (
    <MainViewPageBodyConfig setHedearName="Hospital Admin Update Insurance">
      <Formik
...
export default HospitalAdminMainBodyUpdateInsurance