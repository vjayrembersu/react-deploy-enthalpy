...
const HospitalAdminMainBodyDeleteInsurance = () => {
  const options = [
  ...
  return (
    <MainViewPageBodyConfig setHedearName="Hospital Admin Delete Insurance">
      <Formik
...
export default HospitalAdminMainBodyDeleteInsurance